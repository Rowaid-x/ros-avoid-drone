...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Add RViz for LiDAR visualization
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz2',
        ...
        Node(
            package='obstacle_avoidance_package',  # Replace with your package name
            executable='obstacle_avoidance_node',  # Replace with your node name
            name='obstacle_avoidance',
            namespace=model_ns,
            output='screen',
            remappings=[
                ('/lidar_scan', '/processed_lidar_scan'),  # Adjust topic names as needed
                ('/cmd_vel', '/cmd_vel_safe')  # Remap to a safe velocity topic
            ],
            parameters=[
                {'safety_distance': 1.0},  # Example parameter for obstacle avoidance
            ],
        ),
    ])
